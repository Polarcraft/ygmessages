...
public class LoginEvent implements Listener {
    ...
    public void loginEvent(PlayerLoginEvent event)
    {
        ...
        {
        	String bantime = 
        	String BanEvent = ChatColor.translateAlternateColorCodes('&', (String)Main.this.getConfig().getString("ban-message").replaceAll("%PLAYER%", p.getName().toString()));
        	event.setKickMessage(BanEvent);
        }**/
    }
}
